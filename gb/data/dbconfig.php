...
define('G5_MYSQL_USER', 'summerlee');
define('G5_MYSQL_PASSWORD', 'summer1216');
define('G5_MYSQL_DB', 'summerlee');
define('G5_MYSQL_SET_MODE', false);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '36765544514f53577271777948646f4a'); // 토큰 암호화에 사용할 키
