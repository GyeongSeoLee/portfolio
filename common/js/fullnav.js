   ...
   var on_off=false;  //false(안오버)  true(오버)
       ...
       $('#headerArea').mouseenter(function(){
          ...
          $('.logo a').css('background','url(http://summerlee.cafe24.com/common/images/logo02.png)');
      ...
      $('#headerArea').mouseleave(function(){
           ...
           if(scroll<smh-50 ){
               $('.logo a').css('background','url(http://summerlee.cafe24.com/common/images/logo01.png)');
